document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".planets-navigation-list");
  const headerRef = document.querySelector(".planets-header");
  const navigationRef = document.querySelector(".planets-navigation");
